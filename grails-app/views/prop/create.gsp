...
<g:form action="save" >
    <div style=" width:50%;height: 50%;box-shadow: 0 1px 4px grey;margin:60px auto;display: flex;justify-content: center;align-items: center">
        <div style="width: 50%;height: 50%;text-align: center;padding-top: 10px">
            Name:<input type="text" name="name" style="margin-bottom: 10px;"/>
            <br>
            Size:<input type="text" name="size" style="margin-bottom: 10px;"/>
            <br>
            color:<input type="text" name="color" style="margin-bottom: 10px;"/>
            <br>
